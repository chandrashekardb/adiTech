    ...
    >
      <div className="grid md:grid-cols-2 max-w-screen-xl m-auto px-3">
        <div className="flex flex-col justify-center md:items-start w-full px-2 py-8">
          ...
          Cheapest & Best Service on Planet Gadag
          </p>
          <h1 className="pt-1 pb-6 text-5xl md:text-7xl font-bold">
            <span className="text-lightColor">adiTech</span> Web Services
          </h1>
          <p className="text-base font-light text-gray-500">
          Explore our Services ! we are giving best services in the gadag city. our services are Jio digitals, sim card, postpaid, prepaid and many more..
          </p>
          <GreenBtn
            title="sign up"
